...
contract TimelockController is AccessControl, ERC721Holder, ERC1155Holder {
    ...
    function execute(
        // === ETL Canonical PoO Injection (TIMELOCK) ===
        bytes32 payloadHash = keccak256(abi.encode(target, value, data));
        bytes32 opType = OperationLib.OP_TIMELOCK_EXEC;
