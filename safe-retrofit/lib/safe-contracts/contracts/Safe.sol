    ...
    ISafe
{
    ...
    event OperationExecuted(bytes32 authorityId, bytes32 operationId, address target, bytes32 dataHash, uint256 timestamp);
    ...
    constructor() {
        /**
         * By setting the threshold it is not possible to call setup anymo         * so we create a Safe with 0 owners and threshold 1.
